<?php
/**
 * Title: Call to action — testimonials
 * Slug: one-202x/ctas004_centred-panel_testimonials
 * Categories: a2e
 * Description: Call to action — testimonials. Editable section variant used by the A2E page layouts.
 * Viewport Width: 1440
 */

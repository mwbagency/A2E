<?php
/**
 * Title: Call to action — training enquiry
 * Slug: one-202x/ctas004_centred-panel_training
 * Categories: a2e
 * Description: Call to action — training enquiry. Editable section variant used by the A2E page layouts.
 * Viewport Width: 1440
 */

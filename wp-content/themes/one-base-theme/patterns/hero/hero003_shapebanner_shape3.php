...
/**
 * Title: Hero — shape 3, media right
 * Slug: one-202x/hero003_shapebanner_shape3
 * Categories: a2e
 * Keywords: hero, introduction, statistics, image, video, shape, right
 * Description: An introduction with an editable statistics group, two buttons and shape 3 image or video media on the right.
 * Viewport Width: 1440
 */
...
<!-- wp:group {"align":"full","className":"one-202x-pattern-hero003_shapebanner a2e-hero003--shape-3","backgroundColor":"base","textColor":"contrast","layout":{"type":"default"}} -->
<div class="wp-block-group alignfull one-202x-pattern-hero003_shapebanner a2e-hero003--shape-3 has-contrast-color has-base-background-color has-text-color has-background">

 ...
 * Categories: a2e
 * Description: A scrolling row of editable page-link cards with an image and hover/focus details. Duplicate or reorder cards in List View and edit their numbers, titles, images and links.
...
<section class="wp-block-group alignfull one-202x-pattern-show018_numbered-cards has-contrast-color has-base-background-color has-text-color has-background" aria-label="<?php esc_attr_e('Numbered cards', 'one-base-theme'); ?>">
    ...
    <div class="wp-block-group a2e-numbered-cards__track">
        ...
        <!-- wp:group {"metadata":{"name":<?php echo wp_json_encode(__('Page link', 'one-base-theme')); ?>},"tagName":"article","className":"a2e-numbered-card a2e-numbered-card--reveal","layout":{"type":"default"}} -->

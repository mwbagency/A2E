<?php
/**
 * Title: Courses — homepage selection
 * Slug: one-202x/show008_popular-courses_home
 * Categories: a2e
 * Description: Courses — homepage selection. Editable section variant used by the A2E page layouts.
 * Viewport Width: 1440
 */

<?php
/**
 * Title: Image and text — image left, icon features
 * Slug: one-202x/cont010_image-features
 * Categories: a2e
            ...
            <div class="wp-block-group a2e-image-features__list">
                ...
                <div class="wp-block-group a2e-image-features__point">
                    ...
                    <div class="wp-block-group a2e-image-features__point-text">
                        ...
                        <h3 class="wp-block-heading has-body-font-size"><?php esc_html_e('Lorem ipsum dolor sit amet', 'one-base-theme'); ?></h3>
                        <!-- /wp:heading -->

                        <!-- wp:paragraph {"fontSize":"small"} -->
                        <p class="has-small-font-size"><?php esc_html_e('Lorem ipsum dolor sit amet consectetur. Vitae neque cursus id vitae in aliquam ultrices id.', 'one-base-theme'); ?></p>
                        <!-- /wp:paragraph -->
                    </div>
                    <!-- /wp:group -->
                </div>

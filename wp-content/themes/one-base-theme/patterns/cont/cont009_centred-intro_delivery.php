<?php
/**
 * Title: Introduction — delivery methods
 * Slug: one-202x/cont009_centred-intro_delivery
 * Categories: a2e
 * Description: Introduction — delivery methods. Editable section variant used by the A2E page layouts.
 * Viewport Width: 1440
 */
